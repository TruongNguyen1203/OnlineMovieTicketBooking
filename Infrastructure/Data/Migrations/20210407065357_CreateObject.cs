...
{
    public partial class CreateObject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityUseByUser = table.Column<string>(nullable: true),
                    Code = table.Column<string>(nullable: true),
                    Points = table.Column<int>(nullable: false),
                    PictureUrl = table.Column<string>(nullable: true),
                    DateStart = table.Column<DateTime>(nullable: false),
                    DateEnd = table.Column<DateTime>(nullable: false),
                    MaximumDiscount = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodBills", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<int>(nullable: false),
                    VND = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<int>(nullable: false),
                    TotalPrice = table.Column<decimal>(nullable: false),
                    FoodBillId1 = table.Column<string>(nullable: true),
                    FoodBillId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_FoodBills_FoodBillId1",
                        column: x => x.FoodBillId1,
                        principalTable: "FoodBills",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureUrl = table.Column<string>(nullable: true),
                    Price = table.Column<decimal>(nullable: false),
                    FoodBillId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Foods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Foods_FoodBills_FoodBillId",
                        column: x => x.FoodBillId,
                        principalTable: "FoodBills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_FoodBillId1",
                table: "Bills",
                column: "FoodBillId1");

            migrationBuilder.CreateIndex(
                name: "IX_Foods_FoodBillId",
                table: "Foods",
                column: "FoodBillId");
